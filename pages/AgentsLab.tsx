            ...
            {QUICK_ACTIONS.map((action) => (
              <button
                ...
                className={`text-left p-5 rounded-2xl border transition-all group ${
                  isLight ? 'bg-slate-50 border-slate-200 hover:border-emerald-500 hover:bg-white' : 'bg-slate-950/40 border-slate-800 hover:border-emerald-500/50 hover:bg-slate-800/40'
                }`}
              >
                <p className="text-[10px] font-black uppercase tracking-[0.25em] text-emerald-500 mb-2">Fluxo Guiado</p>
                ...
                <div className="flex items-center gap-2 mt-4 text-[10px] font-black uppercase tracking-[0.2em] text-emerald-600">
        ...
        <div className="flex-1 flex flex-col min-h-0">
          ...
          <div className={`flex-1 min-h-0 border rounded-[40px] overflow-hidden shadow-2xl flex flex-col lg:flex-row ${
            ...
            <div className="flex-1 h-full min-h-[500px] space-y-4 p-4 lg:p-6">
              {suggestedPrompt && (
                <div className={`p-4 rounded-2xl border text-[11px] font-bold uppercase tracking-tight ${isLight ? 'bg-emerald-50 border-emerald-200 text-emerald-800' : 'bg-emerald-900/20 border-emerald-800 text-emerald-200'}`}>
